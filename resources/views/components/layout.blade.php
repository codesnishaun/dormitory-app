...
<body class="">
    <header>
        <nav class="sticky top-0 z-20 flex items-center justify-between px-[6vw] py-5 bg-[#16231C]/85 backdrop-blur-md backdrop-saturate-150 border-b border-paper/10">
