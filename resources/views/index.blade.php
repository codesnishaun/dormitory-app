<x-layout>
    ...
    <section class="relative overflow-hidden px-[6vw] pt-[9vw] pb-[6vw] grid grid-cols-1 lg:grid-cols-[1.1fr_0.9fr] gap-12 items-center">
    ...
    <div class="relative z-10">
        ...
        <h1 class="font-display text-[clamp(2.4rem,4.6vw,4rem)] leading-[1.03] tracking-tight text-paper max-w-[15ch]">
            Your dormitory, <em class="text-copper not-italic">metered, monitored,</em> and one message away.
        </h1>
